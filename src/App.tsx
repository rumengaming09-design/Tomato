...
{ name: "Плато за ценители", price: "45€", info: "Комбинация от премиум мезета и специален хляб" }
...
{ name: "Butcher's Pan", price: "7,70€", info: "250 g /beef tongue, tripe, liver, mushrooms and wine/" },
...
{t.privateEventsHeader.split(" ").slice(0, 2).join(" ")} <br /> {t.privateEventsHeader.split(" ").slice(2).join(" ")}

</h2>

<p className="mt-8 text-white/60 text-lg max-w-2xl mx-auto font-light leading-relaxed italic">

{t.privateEventsSubtitle}
...
{t.privateEventsDesc1}

</p>

<p className="text-white/80 text-base leading-relaxed">

{t.privateEventsDesc2}
...
<div className="w-1.5 h-1.5 bg-jazz-gold rounded-full mt-2 shrink-0"></div>

<span className="text-white/70 text-sm">{t.privateEventsRentalCondition1}</span>
...
<span className="text-white/70 text-sm">{t.privateEventsRentalCondition2}</span>
...
<span className="text-white/70 text-sm">{t.privateEventsRentalCondition3}</span>
...
<span className="text-white/70 text-sm">{t.privateEventsRentalCondition4}</span>
...
<span className="text-white/70 text-sm">{t.privateEventsRentalCondition5}</span>
...
<span className="text-white/70 text-sm">{t.privateEventsRentalCondition6}</span>
...
<div className="w-10 h-10 rounded-full border border-jazz-gold/30 flex items-center justify-center group-hover:bg-jazz-gold/10 transition-colors">

<Users size={18} className="text-jazz-gold" />

</div>

<span className="text-white/80 text-sm font-light">{t.privateEventsRoomMain}</span>
...
<span className="text-white/80 text-sm font-light">{t.privateEventsRoomGarden}</span>
...
<span className="text-white/80 text-sm font-light">{t.privateEventsRoomBar}</span>
...
className="mt-6 px-8 py-4 bg-jazz-gold text-jazz-black text-[10px] uppercase tracking-[0.4em] font-black hover:bg-white transition-all duration-500"
