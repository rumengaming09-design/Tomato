...
const LANGUAGES = {
  BG: {
    ...
    workingHoursWeek: "Понеделник-сряда от 8ч до 17ч",
  ...
  EN: {
    ...
    workingHoursWeek: "Monday-Wednesday: 8am - 5pm",
    workingHoursThuFri: "Thursday-Friday: 8am - 11pm",
    workingHoursSat: "Saturday: 4pm - 11pm",
